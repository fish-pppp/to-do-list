...
- **Web app:** Data lives in browser storage only; there is no User Data Folder. A personal Vercel deploy can add one optional Blob backup from Settings → Sync & Backup. See [[3.05-Web-App-vs-Desktop]].
